...
def button_press_round():
    make_action('round')

def button_press_log():
    make_action('log')
...
def button_press_result():
    ...
    if action == '+':
        ...
        number = math.sqrt(previous_number)
    elif action == "log":
        number = math.log(previous_number, number)
    elif action == "round":
        round(previous_number, number)
...
Button(window, text='^', height=5, width=10, command=button_press_step).grid(row=4, column=4)
Button(window, text='sqrt', height=5, width=10, command=button_press_sqrt).grid(row=3, column=4)
Button(window, text='log', height=5, width=10, command=button_press_log).grid(row=2, column=4)
Button(window, text='round', height=5, width=10, command=button_press_round).grid(row=1, column=4)
